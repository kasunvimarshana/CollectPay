        ...
        <View style={styles.form}>
          ...
          {process.env.EXPO_PUBLIC_ENV === 'development' && (
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.infoText}>Admin: admin@trackvault.com</Text>
              <Text style={styles.infoText}>Collector: collector@trackvault.com</Text>
              <Text style={styles.infoText}>Finance: finance@trackvault.com</Text>
